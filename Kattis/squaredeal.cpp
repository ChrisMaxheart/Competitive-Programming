...
int main ()
{
    ...
    cin >> ha >> wa >> hb >> wb >> hc >> wc;

    bool can = false;

    if (ha == hb && ha == hc && (wa + wb + wc) == ha) {
        can = true;
    }
    if (wb + wc == ha && hb == hc && hb + wa == ha) {
        can = true;
    }
    if (wa + wb == hc && ha == hb && ha + wc == hc) {
        can = true;
    }
    if (wc + wa == hb && hc == ha && hc + wb == hb) {
        can = true;
    }

    if (hb + hc == ha && wb == wc && wb + wa == ha) {
        can = true;
    }
    if (ha + hb == hc && wa == wb && wa + wc == hc) {
        can = true;
    }
    if (hc + ha == hb && wc == wa && wc + wb == hb) {
        can = true;
    }
