...
int main ()
{
  ...
  while(cin >> month >> date >> year) {
    ...
    int starthr = stoi(hour);
    int startmin = stoi(min);
    ...
    int hrdif = endhr-starthr;
    int mindif = endmin - startmin;
    ...
    cout << month << " " << date << " " << year << " " << hrdif << " hours " << mindif << " minutes" << endl;
