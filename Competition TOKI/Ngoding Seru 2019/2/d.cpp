...
int main ()
{
    ...
    for (int batas = biru; batas <= N-kuning; batas++) {
        vi posbirukosong, posbiru, poskuning, poskuningkosong;
        for (int i = 0; i < N; i++) {
            if (x[i] == 'B') {
                if (i < batas) {
        ...
        for (int i = 0; i < posbiru.size(); i++) {
            ttl += posbirukosong[posbirukosong.size()];
        }
    }
